...
function Cat() {
  ...
  const catModelFiles = [
  './models/oiiaioooooiai_cat/scene.gltf',
  './models/oiiaioooooiai_cat/scene.bin',
  './models/oiiaioooooiai_cat/textures/Muchkin2_baseColor.png',
  ];
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <DownloadButton modelName="cat" modelFiles={catModelFiles} />
      </div>
    </>
  );
}
